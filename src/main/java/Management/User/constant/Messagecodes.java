package Management.User.constant;
...
public class Messagecodes {
    ...
    //Custom
    public static final String SUCCESS_ADD = "Answer Added Successfully.";
    public static final String SUCCESS_UP = "Answer Updated Successfully.";
    public static final String SUCCESS_DEL = "Answer Deleted Successfully.";
    public static final String SUCCESS_VIEW = "Answer Retrieved Successfully.";
    ...
    public static final String Bill="O-";
    public static final String LOGIN="Logged In Successfully";
    public static final String SIGNUP="Signed In Successfully";
    public static final String EMAIL="Mail Sent Successfully";
}
